...
title = Label(window, text = "My profile card", fg="white", bg="green", width=40)
title.grid(row=0,column=0,columnspan=2, padx=10,pady=10)



name_label = Label(window, text="Name:", fg="black", bg="purple", width = 25)
...
hobby_label = Label(window,text='Hobby:',fg='black',bg='purple', width=25)
