...
print("=== Science Notes ===")
with open("C:\\Users\\roshm\\OneDrive\\Desktop\\VS CODE STUFF\\.vscode\\Py game stuff\\Huge Projects\\Widgets\\Science-notes.txt","r") as f:
    for line in f:
        print(line.strip())
print()
...
print("===Word Count ===")
with open("C:\\Users\\oshm\\OneDrive\\Desktop\\VS CODE STUFF\\.vscode\\Py game stuff\\Huge Projects\\Widgets\\maths-notes.txt", "r") as f:
    for line in f:
        words = line.split()
...
if os.paths.exist("all-notes.txt"):
