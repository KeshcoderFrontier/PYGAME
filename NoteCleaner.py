...
file = open("C:\\Users\\roshm\\OneDrive\\Desktop\\VS CODE STUFF\\.vscode\\Py game stuff\\Huge Projects\\Widgets\\class-notes.txt","r")
print(file.read(n))
file.close()
print()
...
for i in range(0, len(lines),2):
    out.write(lines[i])
out.close()
print("Odd lines save to odd-lines.txt")